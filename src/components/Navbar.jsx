                ...
                <nav className="navbar navbar-expand-lg navbar-bg">
                    <div className="container-fluid wrapper">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            {!isUserLoggedIn ? <Link className="btn btn-primary" to="/signin">Login</Link> : <div className="flex flex_row flex_center gap-1 btn btn-outline-danger" onClick={() => handleLogout()}><span><i className="fa-solid fa-arrow-right-from-bracket"></i></span><div>Logout</div></div>}
                        </div>
                    </div>
                </nav>
            </header>
